  ...
  App.coderoom = App.cable.subscriptions.create("CoderoomChannel", {
    ...
    received: function(data) {
      if ($('#' + data.user_id + '.user').length === 0) {
        return window.whiteboard.setValue(data.content);
      }
    },
...
(function() {
  ...
  ready = function() {
    ...
    window.whiteboard.on('keyup', function(event) {
    ...
    $('#run_script').click(function() {
      ...
      return $.ajax({
        ...
        success: function(data) {
          return window.output.setValue(data["return"]);
        }
      });
    });
    return $('#clear_output').click(function() {
      var id;
      id = $('.code_container').attr('id');
      return $.ajax({
        type: 'GET',
