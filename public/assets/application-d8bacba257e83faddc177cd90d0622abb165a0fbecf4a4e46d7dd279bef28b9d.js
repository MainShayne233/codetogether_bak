  ...
  App.coderoom = App.cable.subscriptions.create("CoderoomChannel", {
    ...
    received: function(data) {
      if ($('#' + data.user_id + '.user').length === 0) {
        return window.codeMirror.setValue(data.content);
      }
    },
    type: function(id, content, user_id) {
...
(function() {
  ...
  ready = function() {
    ...
    window.codeMirror.on('keyup', function(event) {
    ...
    return $('#run_script').click(function() {
      var id;
      id = $('.code_container').attr('id');
      return $.ajax({
        type: 'GET',
        ...
        success: function(data) {
          return $('#output').html(data["return"]);
        }
      });
    });
  };
